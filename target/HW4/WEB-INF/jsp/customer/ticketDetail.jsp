    ...
    <div class="ticket_introduce">
        ...
        <div class="ticket_introduce_text">
            ...
            <div class="addFavorite">
                ...
                <c:if test="${isFavorite eq 'false'}">
                    <input type="button" name="favorite" id="favorite" value="Add to Favorite" />

                    <input type="button" name="remove" id="remove" value="Remove Favorite" style="display: none" />

                </c:if>
                <c:if test="${isFavorite eq 'true'}">
                    <input type="button" name="remove" id="remove" value="Remove Favorite" />
                    <input type="button" name="favorite" id="favorite" value="Add to Favorite" style="display: none" />
                </c:if>
        ...
        <div class="planBox">
            <div class="planBox_title">
                <span>Select date and session</span>
            </div>
                ...
                <form id="orderForm" action="placeOrder.htm" method="post">
                    <table id="orderTable" >
                        <tr>
                            ...
                            <td>
                                <input type="date" id="selectedDate" name="selectedDate" placeholder="mm/DD/yy">
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="totalPrice" id="totalPrice" value=${ticket.price}/>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <input type="submit" name="placeOrder" id="placeOrder" value="Get it Now"/>
                            </td>
                        </tr>
                        <input type="hidden" name="ticketID" value="${ticket.ticketID}"/>
                        <input type="hidden" name="orderCategory" value="2"/>
                    ...
                    <script type="text/javascript">
                        ...
                        minus.onclick = function (){
                            if(number > 1){
                                ...
                                document.getElementById("totalPrice").value = number*${ticket.price};
                            }else{
                                minus.disabled = true;
                            }
